import { ApplicationRef, ComponentFactoryResolver, ComponentRef, ElementRef, EmbeddedViewRef, Injectable, Injector, OnDestroy, Type } from '@angular/core';
...
@Injectable()
export class InlineDialogService implements OnDestroy {
	...
	private appendInlineDialogToElement(component: any): void {
		const componentRef = this.componentFactoryResolver
								 .resolveComponentFactory(InlineDialogComponent)
